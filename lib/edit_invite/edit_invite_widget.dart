...
class EditInviteWidget extends StatefulWidget {
  ...
  @override
  State<EditInviteWidget> createState() => _EditInviteWidgetState();
}

class _EditInviteWidgetState extends State<EditInviteWidget> {
  late EditInviteModel _model;
                          ...
                          Container(
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                TextFormField(
                                  controller: _model.eventAboutTextController,
                                  focusNode: _model.eventAboutFocusNode,
                                  autofocus: true,
                                  obscureText: false,
                                  decoration: InputDecoration(
                                  ...
                                  maxLines: 5,
                                  validator: _model
                                      .eventAboutTextControllerValidator
                                      .asValidator(context),
                                ),
                              ].divide(SizedBox(height: 5.0)),
                            ),
                          ...
                          Container(
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                TextFormField(
                                  controller: _model.eventEmailTextController,
                                  focusNode: _model.eventEmailFocusNode,
                                  autofocus: true,
                                  obscureText: false,
                                  decoration: InputDecoration(
                                    labelStyle: FlutterFlowTheme.of(context)
                                  ...
                                  validator: _model
                                      .eventEmailTextControllerValidator
                                      .asValidator(context),
                                ),
                              ].divide(SizedBox(height: 5.0)),
                            ),
