...
class AdicionarGlicemiaWidget extends StatefulWidget {
  ...
  static String routeName = 'AdicionarGlicemia';
  static String routePath = '/adicionarGlicemia';
                    ...
                    child: FFButtonWidget(
                      onPressed: () async {
                        _model.apiResponse =
                          ...
                          valor: int.tryParse(_model.valorTextController.text),
                          medida: 'mg/dL',
                          periodo: _model.periodoValue,
                          dataHoraDeRegistro: _model.datePicked4?.toString(),
                        );
                        ...
                        if ((_model.apiResponse?.succeeded ?? true)) {
                          ScaffoldMessenger.of(context).showSnackBar(
                            SnackBar(
                              content: Text(
                                'Glicemia adicionada com sucesso',
                                style: TextStyle(
