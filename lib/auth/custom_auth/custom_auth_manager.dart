...
class CustomAuthManager {
  ...
  Future signOut() async {
    ...
    vittaglicoAuthUserSubject.add(
      VittaglicoAuthUser(loggedIn: false),
    );
    persistAuthData();
  }

  Future<VittaglicoAuthUser?> signIn({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
  ...
  VittaglicoAuthUser? _updateCurrentUser({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
    ...
    final updatedUser = VittaglicoAuthUser(
      loggedIn: true,
      uid: authUid,
    );
    vittaglicoAuthUserSubject.add(updatedUser);
    persistAuthData();
    return updatedUser;
  }
...
VittaglicoAuthUser? currentUser;
