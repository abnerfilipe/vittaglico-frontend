...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFFB74E82);
  late Color secondary = const Color(0xFFF5D0E2);
  late Color tertiary = const Color(0xFFB74E82);
  late Color alternate = const Color(0xFF402D64);
  late Color primaryText = const Color(0xFF222248);
  late Color secondaryText = const Color(0xFF57636C);
  late Color primaryBackground = const Color(0xFFF1F4F8);
  late Color secondaryBackground = const Color(0xFFFFFFFF);
  late Color accent1 = const Color(0xFFDADADA);
  ...
  late Color iconColor = const Color(0xFF0A014F);
  late Color borderColor = const Color(0xFFDADADA);
}
