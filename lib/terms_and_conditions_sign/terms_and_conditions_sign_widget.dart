...
import 'terms_and_conditions_sign_model.dart';
export 'terms_and_conditions_sign_model.dart';

class TermsAndConditionsSignWidget extends StatefulWidget {
  const TermsAndConditionsSignWidget({super.key});

  static String routeName = 'Terms_and_conditionsSign';
  static String routePath = '/termsAndConditionsSign';

  @override
  State<TermsAndConditionsSignWidget> createState() =>
      _TermsAndConditionsSignWidgetState();
}

class _TermsAndConditionsSignWidgetState
    extends State<TermsAndConditionsSignWidget> {
  late TermsAndConditionsSignModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => TermsAndConditionsSignModel());
